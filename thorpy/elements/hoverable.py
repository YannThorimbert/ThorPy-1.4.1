"""Set fusionners as a reaction to a pygame event."""
...
##                self.remove_reaction(self._help_reaction)
    ...
    def _set_hovered_states_auto(self, color=style.COLOR_TXT_HOVER):
        ...
        _states = self.normal_params.params.get("states hover")
        typ = self.normal_params.params.get("typ hover", "painter")
        self.set_hovered_states(_states, typ, params)
